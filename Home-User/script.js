...
let italyDiv = document.getElementById("singleBed-div");
let italyText = document.getElementById("singleBed-text");
...
function redirecToRooms(){
       alert('Room is Available! Book now')
}
